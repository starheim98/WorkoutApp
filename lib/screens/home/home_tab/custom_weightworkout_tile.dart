...
class CustomWeightworkoutTile extends StatefulWidget {
  ...
  CustomWeightworkoutTile({Key? key, required this.weightWorkout}) : super(key: key);

  @override
  _CustomWeightworkoutTileState createState() => _CustomWeightworkoutTileState();
}
                      ...
                      children: [
                        ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              return Center(child: Text(getExerciseNames(weightWorkout!)[index]));
                            }),
                      ],
                    ),
                  ),
